...
public class AuditLogsUserLoginTestCase23 {
	WebDriver driver;

	public AuditLogsUserLoginTestCase23(WebDriver driver)
	{
		this.driver=driver;
...
//		action.click(system).perform();
	...
	public void verifyuserlogin()
	{
		...
		auditlogsearch.sendKeys("logged");
	 ...
	 // Find the first row that contains "Logged"
	    WebElement firstLoggedCell = wait.until(ExpectedConditions.presenceOfElementLocated(
	        By.xpath("//tr[1]/td[contains(text(),'Logged')]")
	    ));
