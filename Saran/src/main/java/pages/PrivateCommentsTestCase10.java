...
public class PrivateCommentsTestCase10 {
	WebDriver driver;
	public PrivateCommentsTestCase10(WebDriver driver)
	{
		this.driver=driver;
	...
	public void verifyComplaintList(String complaintid,String privatecomment) throws InterruptedException
	{
		complaint.click();
		...
		for (WebElement row : tableRows) {
		  ...
		  JavascriptExecutor jsscrolldown=(JavascriptExecutor) driver;
		    ...
		    //WRITE MESSAGE IN PRIVATECOMMENT
		    
		    WebElement privatecommenttext = driver.findElement(By.xpath("//textarea[@id=\"privateCommentTxtID\"]"));
		    jsscrolldown.executeScript("arguments[0].scrollIntoView(true);", privatecommenttext);
		    privatecommenttext.click();
		    privatecommenttext.sendKeys(privatecomment);
		    
		    //CLICK SUBMIT BUTTON
		    WebElement submit = driver.findElement(By.xpath("(//button[text()='Submit'])[1]"));
		    jsscrolldown.executeScript("arguments[0].scrollIntoView(true);", submit);
		    submit.click();
