...
public class AuditLogTicketUpdateTestCase23 {
	WebDriver driver;

	public AuditLogTicketUpdateTestCase23(WebDriver driver)
	{
		this.driver=driver;
...
//		action.click(system).perform();
	...
	public void verifyUpdateTicket()
	{
		...
		auditlogsearch.sendKeys("Tag created");
	 ...
	 // Find the first row that contains "Logged"
	    WebElement firstLoggedCell = wait.until(ExpectedConditions.presenceOfElementLocated(
	        By.xpath("//tr[1]/td[contains(text(),'Tag created')]")
	    ));
