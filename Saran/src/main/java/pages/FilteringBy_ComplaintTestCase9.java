...
public class FilteringBy_ComplaintTestCase9 {
	WebDriver driver;
	public FilteringBy_ComplaintTestCase9(WebDriver driver)
	...
	public void clickFilterByComplaintTitle(String title) throws InterruptedException
	{
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
	...
	public void clickFilterByComplaintID(String id) throws InterruptedException
	{
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
