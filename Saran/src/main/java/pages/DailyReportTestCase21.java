...
public class DailyReportTestCase21 {
	WebDriver driver;
	public DailyReportTestCase21(WebDriver driver)
	{
		this.driver=driver;
	...
	public void generateReport(String profilefield,String compltype,String categoryfield,String statusvalue,String assigneevalue,String selectcreateduserfield,String reportformatfield)
	{
		...
		WebElement radiobutton=driver.findElement(By.xpath("//input[@id=\"daily\"]"));
		radiobutton.click();
		...
		WebElement generatereport=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id=\"generateReport\"]")));
