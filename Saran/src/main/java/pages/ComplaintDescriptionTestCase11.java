...
public class ComplaintDescriptionTestCase11 {
	WebDriver driver;
	public ComplaintDescriptionTestCase11(WebDriver driver)
	{
		this.driver=driver;
...
//		}
	...
	public void ensureComplaintDescription()
	{
		WebElement compldescription=driver.findElement(By.xpath("//h5[contains(text(),'Complaint Description')]/following-sibling::div//span"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true)", compldescription);
		Assert.assertTrue(compldescription.isDisplayed(), "Complaint Description is missing!");
