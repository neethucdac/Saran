...
public class ComplaintviewingTestCase5 extends Base {
	@Test
	
	public void verifyListingallComplaints() throws IOException
	{
		...
		ComplaintViewingTestCase5 clt=new ComplaintViewingTestCase5(driver);
		String id=ExcelUtility.readStringData(1, 0, "viewingcomplaint");
		clt.clickComplaint(id);
		clt.verifyLink();
	}
